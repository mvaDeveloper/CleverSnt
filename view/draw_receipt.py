...
def main(lot_number, cost_payment, date_payment, membership_fee, electricity, date_begin,
    ...
    receipt = general(lot_number, cost_payment, second_name, patronymic, address, first_name)
    ...
    show_save(img_receipt, name_receipt)
...
def optional(lot_number, cost_payment, second_name, patronymic, address, first_name):
    ...
    show_save(receipt[0], name_receipt)


def general(lot_number, cost_payment, second_name, patronymic, address, first_name):
...
def show_save(img_receipt, name_receipt):
